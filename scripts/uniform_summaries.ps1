...
$summaries = @{
  '1'  = "Par une nuit de pluie à Bukavu, Marie comprend que le destin de son fils vient de basculer.";
  '2'  = "Au lendemain du drame, Samuel se tait, tandis que l'enquête de David fait surgir les premières fissures.";
  '3'  = "Seule contre tous, Aline refuse de condamner Samuel et pressent l'ombre d'un piège plus vaste.";
  '4'  = "Dans la chambre d'hôpital, Marie affronte le silence de son fils avec la patience obstinée d'une mère.";
  '5'  = "Retour sur la chute de Samuel: le besoin d'appartenance l'a conduit à franchir la première limite.";
  '6'  = "Au milieu du rejet et des soupçons, la présence d'Aline devient pour Samuel un fragile point d'ancrage.";
  '7'  = "En recoupant les indices, David comprend que Samuel n'est peut-être qu'un pion d'un dispositif criminel.";
  '8'  = "Rongé par la jalousie, Jordan laisse la rancoeur guider chacun de ses choix jusqu'au point de rupture.";
  '9'  = "Une lettre oubliée révèle à Marie que le passé de la famille nourrit encore les menaces du présent.";
...
Write-Output "Summaries updated"